    ...
    ?>
        ...
        include 'connect.php';
            if(isset($_POST['submit']))
            {
                ...
                $insert1="INSERT INTO wp_hoadon(idnd,hoten,diachi,dienthoai,email,ngaydathang,manv) VALUES ('0','$hoten', '$diachi', '$dienthoai', '$email', '$ngay','0')";

                $insert2="INSERT INTO wp_cthoadon(idsp,tensp,gia,soluong,thanhtien,idnd,hoten,ngaydat) select idsp,tensp,gia,soluongsp,thanhtien,'$0','$hoten','$ngay' from wp_giohang" ;                
                
                $insert3="Delete from wp_giohang";                
