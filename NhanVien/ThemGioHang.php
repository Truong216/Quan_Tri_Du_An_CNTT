...
?>
	...
	if(isset($_POST["process"]))
	{
        ...
        $soluonggio = "select soluongmua as df from wp_khohang where id = '$_GET[idsp]'";
    ...
    if($soluong > $tong)
    {
        ...
        <script language='javascript'>
                alert('Sản Phẩm Tạm Thời Hết Hàng ! --- Số Lượng Còn Lại : $tong');
                window.open('NhanVien.php','_self',3);
        </script>
        ";
    }
    else
    {
        $sql="INSERT INTO wp_giohangnhanvien(idsp,tensp,gia,soluongsp,thanhtien) VALUES ('$idsp','$tensp','$gia','$soluong','$thanhtien')";
